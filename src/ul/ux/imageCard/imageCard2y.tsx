...
const ImageCard2:FC<ImageCard1Props> = ({ 
    ...
    return (
        <div className='relative mb-10 w-full h-full flex flex-wrap justify-center items-center gap-3'>
            ...
            <img className='absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12450px] sm:top-[22250px] lg:top-[15020px] right-[300px] z-[2] cursor-pointer' src={images[64]} alt="" />
            <img className='absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12600px] sm:top-[22550px] lg:top-[15215px] right-[300px] z-[2] cursor-pointer' src={images[65]} alt="" />
            <img className='absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12750px] sm:top-[22850px] lg:top-[15215px] right-[600px] z-[2] cursor-pointer' src={images[67]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[15410px] right-[800px] z-[2] cursor-pointer" src={images[68]} alt="" />
            ...
            <img id="arrow" className='absolute top-[12900px] sm:top-[23150px] lg:top-[15310px] rotate-[65deg] right-[100px] z-[2] cursor-pointer' src={arrow2} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[16050px] right-[0px] z-[2] cursor-pointer" src={images[69]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[16050px] right-[600px] z-[2] cursor-pointer" src={images[70]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[16600px] lg:left-1/2 lg:transform lg:-translate-x-1/2 z-[2] cursor-pointer" src={images[74]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[16400px] left-[0px] z-[2] cursor-pointer" src={images[72]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[16450px] right-[0px] rotate-[-35deg] z-[2] cursor-pointer" src={images[73]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[400px] top-[12900px] sm:top-[23150px] lg:top-[17000px] right-[0px] z-[2] cursor-pointer" src={images[75]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[400px] top-[12900px] sm:top-[23150px] lg:top-[17000px] right-[400px] z-[2] cursor-pointer" src={images[76]} alt="" />
            <img id="arrow" className='absolute top-[12900px] sm:top-[23150px] lg:top-[17250px] max-w-[500px] rotate-[65deg] right-[500px] z-[2] cursor-pointer' src={arrow} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[17300px] left-[0px] z-[2] cursor-pointer" src={images[77]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[17550px] rotate-[-25deg] left-[600px] z-[2] cursor-pointer" src={images[78]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[17550px] left-[0px] z-[2] cursor-pointer" src={images[79]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[18100px] right-[0px] z-[2] cursor-pointer" src={images[80]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12900px] sm:top-[23150px] lg:top-[18100px] left-[0px] z-[2] cursor-pointer" src={images[81]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12900px] sm:top-[23150px] lg:top-[18100px] left-[300px] z-[2] cursor-pointer" src={images[82]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[18300px] left-[0px] z-[2] cursor-pointer" src={images[84]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[500px] top-[12900px] sm:top-[23150px] lg:top-[18250px] right-[500px] rotate-[-25deg] z-[2] cursor-pointer" src={images[85]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[18700px] right-[0px] z-[2] cursor-pointer" src={images[86]} alt="" />
            <img id="arrow" className='absolute top-[12900px] sm:top-[23150px] lg:top-[18700px] max-w-[500px] rotate-[155deg] right-[500px] z-[2] cursor-pointer' src={arrow2} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[18910px] left-[0px] z-[2] cursor-pointer" src={images[87]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[400px] top-[12900px] sm:top-[23150px] lg:top-[19100px] right-[200px] z-[2] cursor-pointer" src={images[88]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12900px] sm:top-[23150px] lg:top-[19100px] right-[600px] z-[2] cursor-pointer" src={images[89]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[19293px] left-[337px] z-[2] cursor-pointer" src={images[90]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[336px] top-[12900px] sm:top-[23150px] lg:top-[19464px] left-[0px] z-[2] cursor-pointer" src={images[91]} alt="" />
            ...
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[19730px] right-[0px] z-[2] cursor-pointer" src={images[92]} alt="" />
            <img id="arrow" className='absolute top-[12900px] sm:top-[23150px] lg:top-[19730px] max-w-[500px] rotate-[165deg] right-[500px] z-[2] cursor-pointer' src={arrow2} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[19940px] left-[0px] z-[2] cursor-pointer" src={images[93]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[300px] top-[12900px] sm:top-[23150px] lg:top-[20134px] left-[600px] z-[2] cursor-pointer" src={images[94]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[900px] top-[12900px] sm:top-[23150px] lg:top-[20328px] left-[0px] z-[2] cursor-pointer" src={images[95]} alt="" />
            ...
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[636px] top-[12900px] sm:top-[23150px] lg:top-[20500px] right-[0px] z-[2] cursor-pointer" src={images[96]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[20950px] left-[400px] z-[2] cursor-pointer" src={images[98]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21300px] left-1/2 rotate-[-15deg] translate-x-[-50%] z-[2] cursor-pointer" src={images[100]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21000px] rotate-[45deg] left-[0px] z-[2] cursor-pointer" src={images[97]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21150px] right-[100px] rotate-[-45deg] z-[2] cursor-pointer" src={images[99]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21400px] right-[0px] z-[2] cursor-pointer" src={images[101]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21550px] left-[0px] rotate-[-15deg] z-[2] cursor-pointer" src={images[102]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[21700px] left-1/2 rotate-[15deg] translate-x-[-50%] z-[2] cursor-pointer" src={images[103]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[22150px] left-[0px] z-[2] cursor-pointer" src={images[105]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[400px] top-[12900px] sm:top-[23150px] lg:top-[22150px] right-[0px] z-[2] cursor-pointer" src={images[106]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[500px] top-[12900px] sm:top-[23150px] lg:top-[22250px] right-[400px] z-[2] cursor-pointer" src={images[107]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[450px] top-[12900px] sm:top-[23150px] lg:top-[22400px] right-[0px] z-[2] cursor-pointer" src={images[108]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[22500px] right-[600px] z-[2] cursor-pointer" src={images[109]} alt="" />
            <img id="arrow" className='absolute top-[12900px] sm:top-[23150px] lg:top-[22700px] max-w-[500px] rotate-[350deg] right-[180px] z-[2] cursor-pointer' src={arrow} alt="" />
            ...
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[23060px] right-[100px] z-[2] cursor-pointer" src={images[110]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[23210px] left-[200px] z-[2] cursor-pointer" src={images[111]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[23350px] right-[0px] z-[2] cursor-pointer" src={images[112]} alt="" />
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[23450px] left-1/2 translate-x-[-50%] rotate-[-15deg] z-[2] cursor-pointer" src={images[113]} alt="" />  
            <img className="absolute duration-150 ease-in hover:scale-110 hover:hover:z-[9] lg:max-w-[600px] top-[12900px] sm:top-[23150px] lg:top-[23600px] left-[0px] z-[2] cursor-pointer" src={images[114]} alt="" />
        </div>
    );
}
